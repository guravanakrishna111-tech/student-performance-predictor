...
A Machine Learning web application that predicts a student's exam score based on study habits such as study hours, sleep hours, previous scores, and number of practice tests. The project uses a Linear Regression model and provides an interactive dashboard built with Streamlit to visualize data and generate predictions.
